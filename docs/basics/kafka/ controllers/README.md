...
Navegue até a pasta presentation/event-controllers/controllers e crie um arquivo `event-controller.ts`  
...
src
 ...
 ├─ presentation
 │   └─⊳ event-controllers       
 │       └─⊳ controllers                       // crie uma pasta
 │           └─⊳ event-controller.ts           // crie uma classe
 └─⊳ application
